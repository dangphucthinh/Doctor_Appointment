...
class MessengerViewController: UIViewController {
    ...
    func getAllMessages(){
        ...
        MessageDataManager.getAllMessages(thread: sendUserId! + (recieverUser?.userId)!) { (messages) in
    ...
    @IBAction func onClickSend(_ sender: Any) {
        ...
        MessageDataManager.setMessage(thread: sendUserId! + (recieverUser?.userId)!, messageData: messageData)
        txtMessage.text = ""
    }
}
